...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data pembelian')
...
<section class="content">
        ...
        <hr/>
                ...
                {!! Form::model($pembelian, [
                    'method' => 'PATCH',
                    'url' => ['pembelian', $pembelian->pembelian_id],
                    'class' => 'form-horizontal'
                ]) !!}

            <div class="form-group {{ $errors->has('supplaier_id') ? 'has-error' : ''}}">
                {!! Form::label('supplaier_id', 'Supplaier Id: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('totalpembelian') ? 'has-error' : ''}}">
                {!! Form::label('totalpembelian', 'Total Harga Pembelian: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('statusutang') ? 'has-error' : ''}}">
                {!! Form::label('statusutang', 'Statusutang: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
