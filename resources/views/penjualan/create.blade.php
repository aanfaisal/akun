...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Penjualan')
...
<section class="content">
        ...
        <hr/>
                    ...
                    {!! Form::open(['url' => 'penjualan', 'class' => 'form-horizontal']) !!}

            <div class="form-group {{ $errors->has('nonota_id') ? 'has-error' : ''}}">
                {!! Form::label('nonota_id', 'Nonota Id: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="form-group {{ $errors->has('harga') ? 'has-error' : ''}}">
                {!! Form::label('harga', 'Harga Satuan : ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
