...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data pengeluarankas')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Pengeluaran Kas</a></li>
        <li class="active">Edit Pengeluaran Kas</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Pengeluaran Kas</h1>
                <hr/>

                {!! Form::model($pengeluaranka, [
                    'method' => 'PATCH',
                    'url' => ['pengeluarankas', $pengeluaranka->pengeluarankas_id],
