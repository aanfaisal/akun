...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Jurnal Penjualan')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Jurnal Penjualan</a></li>
        <li class="active">Edit Jurnal Penjualan</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Jurnal Penjualan</h1>
                <hr/>

                {!! Form::model($jurnalpenjualan, [
                    'method' => 'PATCH',
                    'url' => ['jurnalpenjualan', $jurnalpenjualan->jurnalpenjualan_id],
            ...
            <div class="form-group {{ $errors->has('nonota_id') ? 'has-error' : ''}}">
                {!! Form::label('nonota_id', 'ID No.nota : ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
