...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Jurnal Pembelian')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Jurnal Pembelian</a></li>
        <li class="active">Tambah Jurnal Pembelian</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Jurnal Pembelian</h1>
                    <hr/>

                    {!! Form::open(['url' => 'jurnalpembelian', 'class' => 'form-horizontal']) !!}
