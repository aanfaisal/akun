...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Jurnal Umum')
...
<section class="content">
        ...
        <hr/>
                ...
                {!! Form::model($jurnalumum, [
                    'method' => 'PATCH',
                    'url' => ['jurnalumum', $jurnalumum->jurnalumum_id],
            ...
            <div class="form-group {{ $errors->has('ket_jurnal') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::textarea('ket_jurnal', null, ['class' => 'form-control', 'required' => 'required']) !!}
