...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Nomor Nota')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Nomor Nota</a></li>
        <li class="active">Tambah Nomor Nota</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Nomor Nota</h1>
                    <hr/>

                    {!! Form::open(['url' => 'nonota', 'class' => 'form-horizontal']) !!}
